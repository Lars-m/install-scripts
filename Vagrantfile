...
# config.vm.network "forwarded_port", guest: 80, host: 8080, host_ip: "172.25.200.200"
  config.vm.network "forwarded_port", guest: 8080, host: 8085, host_ip: "127.25.200.200"
  config.vm.network "forwarded_port", guest: 3306, host: 3306, host_ip: "127.25.200.200"
